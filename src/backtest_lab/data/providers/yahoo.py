...
from ..base import DataFrequency, DataProvider, MarketData, MarketDataRequest
...
class YahooFinanceProvider(DataProvider):
    ...
    def get_data(self, request: MarketDataRequest) -> MarketData:
        ...
        try:
            ...
            return MarketData(symbol=request.symbol, data=data, metadata=metadata)
    ...
    def get_available_symbols(self) -> List[str]:
        ...
        raise NotImplementedError(
            "Yahoo Finance doesn't provide symbol listing endpoint"
        )
